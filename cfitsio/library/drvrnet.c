...
$Id: drvrnet.c,v 1.3 2008/05/29 15:05:08 lars Exp $

$Log: drvrnet.c,v $
Revision 1.3  2008/05/29 15:05:08  lars
Ported OMP and PDS support to Mac
* Changed the build settings to use GCC 4.2
* Changed Mac specific code
