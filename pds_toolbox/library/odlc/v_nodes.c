  ...
  switch (value->item.type)
   {
    ...
    case TV_INTEGER: case TV_REAL: case TV_NULL_VALUE:
      ...
      else if (value->item.type == TV_REAL)
        {
          units_field = value->item.value.real.units;
        }
      else
        {
          units_field = value->item.value.null_data.units;
        }
  ...
  switch (item_copy.type)
    {
      ...
      case TV_INTEGER:  case TV_REAL: case TV_NULL_VALUE:
        ...
        if (item_copy.type == TV_INTEGER)
        ...
        else if (item_copy.type == TV_REAL)
          {
        ...
        else
          {
            ...
            item_copy.value.null_data.string = strcpy(string, value->item.value.null_data.string); 
            units = value->item.value.null_data.units;
          }
        ...
        if (item_copy.type == TV_INTEGER)
          ...
          {
            item_copy.value.null_data.units = first_units_copy;
          }
